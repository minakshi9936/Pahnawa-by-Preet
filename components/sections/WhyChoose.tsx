export default function WhyChoose() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-white" id="WhyChoose">
      <div className="container max-w-7xl mx-auto px-4">
        <h2 className="section-title text-2xl sm:text-3xl md:text-4xl">Why Choose Pahnawa</h2>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          {features.map((item, index) => (
            <div key={index} className="bg-gradient-to-br from-[#D66B7F] to-[#8B3A62] rounded-lg p-6 sm:p-8 text-white hover:scale-105 hover:shadow-xl transition-all duration-300 cursor-pointer">
